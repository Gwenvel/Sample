...
namespace test2.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(RequestContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var departments = await _context.Departments
                .FirstOrDefaultAsync(m => m.DepartmentsId == id);
            if (departments == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentsId,Department")] Departments departments)
        {
